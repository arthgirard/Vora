...
On définit d'abord la sortie d'un bloc
$$H_k = F(H_{i-1}) + H_{i-1}$$

Notons la dérivée partielle pour un bloc :
$$\frac{\partial H_i}{\partial H_{i-1}} = \frac{\partial F}{\partial H_{i-1}} + 1$$
...
$$ \frac{\partial C}{\partial w_1} = \frac{\partial C}{\partial H_K} \cdot (w_L \cdot w_{L-1} \cdot \sigma^\prime + 1) \cdot \dots \cdot (w_4 \cdot w_3 \cdot \sigma^\prime + 1) \cdot (w_2 \cdot \sigma^\prime \cdot \sigma^\prime  \cdot a_0) $$
